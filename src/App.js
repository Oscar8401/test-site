  ...
  return (
    <div className="App">
      <section>
        <div className="style-one">
          ...
          <div className="style-three">
            <Row >
              <Col sm={6}>
                <div className="title">Hello, and <b>welcome</b></div>
            ...
            <Row className="image-over-button">
              <Col>
                <ButtonToolbar>
                  <Button id="button" variant="warning">Learn more</Button>
                </ButtonToolbar>
              </Col>
            </Row>
          </div>
      ...
      <section>
        ...
        <Row>
          <div className="about-us-container">
            <Col sm={8}>
              <img src={require(`./assest/images/circle.png`)} className="about-us-img" alt="HeroBackground" />
            </Col>
            <Col sm={8}>
      ...
      <section className="section-three">
        <Row>
          <Col><div className="about-us">Projects</div></Col>
        </Row>
        <Row>
          {images.map((num, index) => {
            return <Col sm={3}><img src={require(`./assest/images/Image${num}.png`)} className="project-img" alt="project image" /></Col>
          })}
        </Row>
      </section>
      <section className="section-Four">
        <Row>
          <Col><div className="about-cotact-us">Contact</div></Col>
        </Row>
        <Row>
          <Col sm={6}>
            <InputGroup className="mb-3">
              <FormControl placeholder="Name" aria-label="Amount (to the nearest dollar)"/>
            </InputGroup>
          </Col>
          <Col sm={6}>
            <InputGroup className="mb-3">
              <FormControl placeholder="Email" aria-label="Amount (to the nearest dollar)"/>
            </InputGroup>
          </Col>
        </Row>
        <Row>
          <Col>
            <InputGroup className="mb-3">
              <FormControl placeholder="Message" aria-label="Amount (to the nearest dollar)" as="textarea" rows="3"/>
            </InputGroup>
          </Col>
        </Row>
        <Row>
          <Col>
            <ButtonToolbar>
              <Button id="normal-button" variant="warning">Send message</Button>
            </ButtonToolbar>
          </Col>
        </Row>
      </section>
